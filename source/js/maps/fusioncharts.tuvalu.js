...
(function (factory) {
    ...
    FusionCharts(["private", "modules.renderer.js-tuvalu", function () {
        ...
        geodefinitions = [{
            ...
            entities: {
                ...
                "TV.NA": { 
                    outlines: [
                        [M,435,235,L,435,264,444,264,444,283,465,283,465,294,495,294,495,303,504,303,504,293,534,293,534,272,545,272,545,263,536,263,536,244,524,244,524,234,513,234,513,223,495,223,495,214,445,214,444,235,Z]
                    ], 
                    label: "Nanumea", 
                    shortLabel: "NA", 
                ...
                "TV.NT": { 
                    ...
                    labelAlignment: [LFT,MID], 
                    labelConnectors: [
                        [M,1382,529,L,1234,529]
                    ] 
                },
                "TV.NF": { 
                    outlines: [
                        [M,1956,1704,L,1956,1722,1965,1722,1965,1733,1983,1733,1983,1725,1993,1722,1995,1713,2004,1713,2004,1703,1995,1703,1995,1695,2003,1695,2003,1686,1986,1686,1984,1674,1954,1674,1954,1673,1944,1673,1944,1662,1916,1662,1913,1663,1913,1674,1905,1674,1905,1686,1894,1686,1894,1695,1876,1695,1876,1705,1864,1705,1864,1735,1845,1735,1845,1760,1855,1760,1855,1782,1865,1782,1865,1802,1886,1802,1886,1822,1964,1822,1964,1810,1974,1810,1974,1795,1953,1795,1953,1805,1935,1805,1935,1792,1943,1792,1943,1774,1913,1774,1913,1795,1923,1795,1923,1804,1899,1804,1893,1805,1893,1783,1904,1783,1904,1745,1915,1745,1915,1713,1944,1713,1944,1704,Z]
                    ], 
                    label: "Nukufetau", 
                    shortLabel: "NF", 
                ...
                "TV.FN": { 
                    ...
                    labelAlignment: [CEN,BTM], 
                    labelConnectors: [
                        [M,2480,2298,L,2480,2100]
                    ] 
                },
                "TV.NL": { 
                    outlines: [
                        [M,2852,2594,L,2845,2594,2844,2603,2854,2603,2854,2615,2863,2613,2863,2634,2875,2634,2875,2644,2895,2644,2895,2614,2875,2614,2875,2595,2865,2595,2865,2584,2852,2584,Z]
                    ], 
                    label: "Nukulaelae", 
                    shortLabel: "NL", 
                    ...
                    labelAlignment: [RGT,MID], 
                    labelConnectors: [
                        [M,2739,2604,L,2866,2604]
                    ] 
                },
                "TV.VI": { 
                    outlines: [
                        [M,2154,1385,L,2150,1385,2125,1385,2123,1397,2117,1397,2117,1414,2122,1414,2126,1423,2156,1423,Q,2164,1408,2158,1394,L,2157,1391,Z]
                    ], 
                    label: "Vaitupu", 
                    shortLabel: "VI", 
