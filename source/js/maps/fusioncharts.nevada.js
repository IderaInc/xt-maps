...
(function (factory) {
    ...
    FusionCharts(["private", "modules.renderer.js-nevada", function () {
        ...
        geodefinitions = [{
            ...
            entities: {
                ...
                "017": { 
                    outlines: [
                        [M,5257,5074,L,4397,5074,4397,6534,6147,6534,6147,4315,5252,4315,Z]
                    ], 
                    label: "Lincoln", 
                    shortLabel: "LI", 
                ...
                "009": { 
                    outlines: [
                        [M,1895,5264,L,3167,6455,3167,5129,2667,4560,2033,5264,Z]
                    ], 
                    label: "Esmeralda", 
                    shortLabel: "ES", 
                ...
                "023": { 
                    outlines: [
                        [M,5252,4308,L,4383,3718,3017,3719,2566,3824,2566,3824,2564,3824,2172,3909,2172,4019,2666,4560,3167,5128,3167,6454,4397,7605,4397,5074,5257,5074,5252,4314,Q,5269,4318,5252,4308,Z]
                    ], 
                    label: "Nye", 
                    shortLabel: "NY", 
                ...
                "021": { 
                    outlines: [
                        [M,2172,3910,L,2565,3825,1645,3825,Q,1645,3830,1645,3825,L,1473,3825,Q,1469,3835,1464,3849,1449,3892,1426,3930,1410,3957,1392,3976,1387,3981,1382,3990,L,1382,4090,1502,4090,1497,4635,1222,4635,1895,5264,2032,5264,2666,4560,2172,4020,Z]
                    ], 
                    label: "Mineral", 
                    shortLabel: "MI", 
                ...
                "027": { 
                    outlines: [
                        [M,2698,1569,L,1609,1569,1609,1462,1104,1462,1107,2037,1077,2037,1077,2670,1178,2665,2802,2665,Q,2805,2664,2806,2663,L,3019,2057,3019,1792,2698,1792,Z]
                    ], 
                    label: "Pershing", 
                    shortLabel: "PE", 
                ...
                "007": { 
                    outlines: [
                        [M,3293,125,L,3293,1417,4122,1417,4122,1842,4289,2497,6146,2497,6146,125,Z]
                    ], 
                    label: "Elko", 
                    shortLabel: "EL", 
                ...
                "013": { 
                    outlines: [
                        [M,1609,1569,L,2698,1569,2698,1792,3019,1792,3019,2057,3091,1854,3293,1850,3293,123,1073,123,1073,1462,1609,1462,Z]
                    ], 
                    label: "Humboldt", 
                    shortLabel: "HU", 
