...
FusionCharts(["private", "modules.renderer.js-tamaulipas", function () {
    ...
    geodefinitions = [{
        ...
        entities: {
            "MX.TM.GO": { 
                ...
                labelConnectors: [
                    [M,3451,5911,L,1567,5911]
                ] 
            },
            "MX.TM.AM": { 
                outlines: [
                    [M,1844,6801,L,1660,6374,1660,6375,1527,6375,1527,6513,1644,6697,1644,6775,1782,6790,Z]
                ], 
                ...
                labelConnectors: [
                    [M,1741,6902,L,1741,6681]
                ] 
            },
            "MX.TM.NM": { 
                outlines: [
                    [M,1527,6517,L,1365,6552,1527,6800,Q,1583,6787,1638,6774,1639,6774,1640,6774,1646,6777,1644,6771,L,1644,6697,1529,6516,Z]
                ], 
                label: "Nuevo Morelos", 
                shortLabel: "NM", 
                ...
                labelConnectors: [
                    [M,1220,6962,L,1504,6962,1504,6658,1504,6962]
                ] 
            },
            "MX.TM.MR": { 
                outlines: [
                    [M,999,3939,L,869,4094,872,4144,Q,928,4191,984,4204,L,985,4204,1072,4087,1174,4089,1197,4109,1229,4099,1199,4032,1272,3984,1255,3837,1164,3889,1087,3962,1054,3962,Z]
                ], 
                label: "Villa Mainero", 
                shortLabel: "MR", 
                ...
                labelAlignment: [RGT,MID], 
                labelConnectors: [
                    [M,620,4014,L,984,4014]
                ] 
            },
            "MX.TM.CR": { 
                outlines: [
                    [M,3262,6848,L,3262,6825,Q,3227,6863,3200,6869,3210,6884,3242,6926,3260,6952,3271,6998,3310,6998,3361,6996,L,3362,6996,Q,3360,6957,3323,6918,Q,3265,6854,3262,6848,Z]
                ], 
                label: "Cruillas", 
                shortLabel: "CR", 
                ...
                labelAlignment: [LFT,MID], 
                labelConnectors: [
                    [M,3521,6946,L,3306,6946]
                ] 
            },
            "MX.TM.TA": { 
                outlines: [
                    [M,3200,6870,Q,3194,6871,3189,6871,3147,6868,3104,6868,L,3102,6869,Q,3105,6876,3133,6934,3155,6979,3157,7003,L,3174,7003,Q,3204,7001,3267,7001,3269,6998,3271,6998,3260,6952,3242,6926,Q,3210,6884,3200,6870,Z]
                ], 
                label: "Tampico", 
                shortLabel: "TA", 
            ...
            "MX.TM.GD": { 
                outlines: [
                    [M,1196,698,L,1196,698,Q,1194,698,1192,698,1139,703,1138,703,1090,703,1060,692,1041,684,974,658,974,682,989,698,987,698,987,700,917,705,878,705,870,705,861,704,L,859,708,Q,888,786,892,831,893,850,910,888,927,925,927,933,927,952,916,966,901,980,892,989,857,1024,857,1101,857,1128,883,1133,921,1134,944,1136,1019,1162,1052,1221,L,956,1431,1122,1434,1278,1538,1278,1586,1279,1586,Q,1299,1581,1386,1552,1420,1541,1483,1541,1536,1541,1555,1548,L,1557,1547,1432,1223,1222,981,1222,728,Z]
                ], 
            ...
            "MX.TM.MA": { 
                outlines: [
                    [M,1842,1769,L,1638,1752,Q,1634,1854,1634,1923,L,1537,1923,1537,1929,Q,1537,1936,1522,1946,1516,1950,1513,1952,1507,1955,1507,1956,1535,2000,1537,2014,L,1533,2018,Q,1545,2029,1552,2042,L,1554,2043,1554,2108,Q,1542,2122,1538,2129,1537,2133,1535,2135,1533,2134,1531,2135,1530,2135,1529,2136,L,1529,2143,Q,1547,2143,1571,2162,1596,2183,1592,2198,1618,2196,1650,2175,1681,2154,1689,2153,1728,2151,1754,2126,1755,2124,1757,2123,1759,2120,1761,2118,1768,2109,1772,2101,1777,2101,1782,2072,1788,2039,1792,2033,1795,2026,1808,2017,1820,2007,1822,1996,1827,1961,1827,1951,1828,1946,1840,1932,1850,1920,1847,1913,L,1847,1867,Q,1847,1861,1852,1822,1852,1794,1842,1783,Z]
                ], 
            ...
            "MX.TM.RE": { 
                outlines: [
                    [M,2369,2086,Q,2359,2113,2339,2121,2327,2126,2304,2128,2297,2128,2297,2143,2299,2211,2299,2248,L,2300,2249,2300,2316,2308,2324,2318,2919,2510,2919,2520,2899,2695,2899,Q,2695,2898,2695,2897,L,2697,2896,2698,2896,2724,2887,2725,2887,2738,2906,2739,2906,2739,2928,Q,2774,2940,2855,2941,L,2856,2195,Q,2648,2048,2390,1979,Q,2368,2033,2369,2086,Z]
                ], 
                label: "Reynosa", 
                shortLabel: "RE", 
            ...
            "MX.TM.BR": { 
                outlines: [
                    [M,2070,3412,L,1975,3332,1975,3331,1775,3414,1715,3359,1627,3439,1553,3439,1536,3527,1592,3617,1543,3696,1662,3717,1777,3717,1914,3843,2166,3859,2445,3687,2447,3687,2447,3626,2305,3612,2305,3463,Z]
                ], 
                label: "Burgos", 
                shortLabel: "BR", 
            ...
            "MX.TM.SN": { 
                outlines: [
                    [M,2165,3859,L,1914,3843,1777,3717,1662,3717,1637,3712,1902,3899,2015,4084,2100,4084,2188,4221,2190,4219,2250,4194,2165,3859,Z]
                ], 
                label: "San Nicolas", 
                shortLabel: "SN", 
            ...
            "MX.TM.GG": { 
                outlines: [
                    [M,2552,3687,L,2445,3687,2166,3859,2165,3859,2250,4194,2405,4219,2664,4247,2665,4246,2818,4192,2818,4192,2918,4192,2755,3992,2720,4024,2665,4024,2630,3862,Z]
                ], 
                label: "Gomez Farias", 
                shortLabel: "GG", 
            ...
            "MX.TM.VL": { 
                outlines: [
                    [M,1494,3792,L,1394,3757,1255,3837,1272,3984,1199,4032,1229,4099,1197,4109,1174,4089,1072,4087,985,4204,984,4204,1034,4279,1468,4242,1469,4242,1562,3847,1510,3748,1494,3762,Z]
                ], 
                label: "Villagram", 
                shortLabel: "VL", 
            ...
            "MX.TM.SC": { 
                outlines: [
                    [M,1902,3899,L,1637,3712,1543,3696,1512,3747,1510,3748,1562,3847,1469,4242,1469,4242,Q,1502,4264,1570,4351,1650,4454,1687,4478,1674,4486,1658,4489,1626,4494,1619,4496,1624,4499,1624,4518,1624,4530,1618,4560,1618,4561,1618,4562,L,1725,4587,1820,4634,1860,4502,2156,4574,2157,4573,2072,4252,2190,4272,2190,4224,2100,4084,2015,4084,Z]
                ], 
                label: "San Carlos", 
                shortLabel: "SC", 
            ...
            "MX.TM.LL": { 
                outlines: [
                    [M,2405,4219,L,2250,4194,2190,4219,2190,4272,2072,4252,2157,4574,2156,4575,2290,4824,2364,4826,2504,4614,2595,4614,2665,4404,2665,4247,2664,4247,Z]
                ], 
            ...
            "MX.TM.AB": { 
                outlines: [
                    [M,2818,4259,L,2818,4192,2665,4246,2665,4404,2595,4614,2504,4614,2360,4832,2360,5038,Q,2378,5035,2395,5035,2401,5034,2407,5029,L,2407,5022,2705,4867,2790,4905,2802,4913,2803,4804,2955,4562,2955,4454,3034,4454,3034,4454,3047,4372,3043,4372,Z]
                ], 
                label: "Abasolo", 
                shortLabel: "AB", 
            ...
            "MX.TM.MN": { 
                outlines: [
                    [M,1990,6567,L,1925,6500,1965,6390,1979,6294,Q,1928,6285,1878,6273,1877,6273,1876,6273,1811,6257,1746,6237,1681,6217,1617,6192,L,1659,6372,1844,6801,1855,6803,2077,6817,2135,6765,2398,6765,2398,6760,2347,6550,2197,6527,2142,6467,Z]
                ], 
                label: "El Mante", 
                shortLabel: "MN", 
            ...
            "MX.TM.OC": { 
                outlines: [
                    [M,1079,6344,L,962,6435,961,6435,1109,6524,1157,6502,Z],
            ...
            "MX.TM.BS": { 
                outlines: [
                    [M,877,5362,L,617,5464,615,5464,602,5537,Q,508,5533,414,5502,L,338,5611,420,5665,420,5665,Q,373,5757,370,5849,L,373,5849,542,5805,542,5751,657,5792,784,5750,827,5812,837,5795,892,5795,892,5697,959,5680,959,5520,947,5524,Z]
                ], 
                label: "Bustamante", 
                shortLabel: "BS", 
            ...
            "MX.TM.PL": { 
                outlines: [
                    [M,960,5519,L,960,5680,957,5682,1040,5790,1040,5897,1153,5897,1153,5890,1152,5887,1152,5545,1027,5501,1022,5499,1014,5499,Z]
                ], 
                label: "Palmillas", 
                shortLabel: "PL", 
            ...
            "MX.TM.GR": { 
                outlines: [
                    [M,1171,4834,L,1191,4974,1192,4975,1310,5021,1312,5022,1322,4894,1523,4808,1853,5188,1853,5189,2095,5083,2095,5034,2067,5034,2045,4996,1825,4857,1611,4674,Q,1602,4678,1587,4678,1574,4678,1537,4668,1524,4668,1524,4677,1524,4686,1539,4718,L,1539,4756,1514,4756,Q,1508,4752,1470,4739,L,1174,4837,Z]
                ], 
            ...
            "MX.TM.PD": { 
                outlines: [
                    [M,1611,4674,L,1825,4857,2046,4996,2067,5034,2095,5034,2095,5084,2152,5084,2172,4812,2288,4821,2156,4574,1860,4502,1820,4634,1725,4587,1618,4562,Q,1612,4591,1612,4609,1612,4620,1622,4657,Q,1622,4669,1611,4674,Z]
                ], 
            ...
            "MX.TM.VC": { 
                outlines: [
                    [M,1312,5022,L,1312,5022,1311,5023,1404,5186,1414,5367,1552,5485,Q,1552,5485,1553,5485,1559,5479,1563,5476,1660,5409,1736,5333,1803,5265,1852,5189,L,1853,5189,1523,4808,1322,4895,Z]
                ], 
                label: "Victoria", 
                shortLabel: "VC", 
